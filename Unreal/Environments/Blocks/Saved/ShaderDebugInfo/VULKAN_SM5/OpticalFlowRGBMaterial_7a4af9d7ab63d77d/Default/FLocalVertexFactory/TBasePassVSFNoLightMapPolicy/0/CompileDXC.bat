...
%DXC% -HV 2018 -T vs_6_2 -E Main -spirv -fspv-target-env=vulkan1.1 -Fo BasePassVertexShader.DXC.spv BasePassVertexShader.usf
WHERE %SPIRVCROSS%
IF %ERRORLEVEL% NEQ 0 (
...
%SPIRVCROSS% --vulkan-semantics --output BasePassVertexShader.SPV.glsl BasePassVertexShader.DXC.spv
:END
PAUSE
